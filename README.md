...
- [Y] Use `npx create-react-app team-builder --use-npm` or `create-react-app team-builder` to initiate the project.
- [Y] CD into your `team-builder` directory
...
- [Y] Import the `useState` hook and set up a state property for your team members list

- [Y] Give the state variable you just declared a default value. You will need to keep track of a list of team members and each team member will have several key/value pairs associated with them.

- [Y] Render your list of team members

### STEP 2 - Build your form

- [Y] In `Form.js` build out your markup
- [Y] Build inputs for `name`, `email` and `role` (backend engineer, frontend engineer, designer, etc. Use your imagination)
- [Y] Import the useState hook and utilize what we learned about two-way data binding
- [Y] Render your `Form` component in `App` and pass a setter method (the `set_____` method from your team members state in `App`) down to it so you can add team members to your state.
